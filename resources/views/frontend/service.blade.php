    ...
    <section id="service">
        ...
        <div class="default-section">
            <div class="container">
                ...
                <h1 class="default-title">Authentic Experience</h1>
        ...
        <div class="default-section secondary">
            ...
            <div class="container">
                ...
                <div class="media gift-card">
                    <img class="icon" src="{!! url('/') !!}/assets/frontend/images/gift-icon-1.png" alt="Gift Icon">
                    <div class="media-body">
                        <h5 class="mt-0">Wonderful Gift</h5>
                        <p>We bestow authentic connection with stories with the locals through personalised travelling, We connect travellers with our native guides who know their localities more than anyone else.We bestow authentic connection with stories with the locals through personalised travelling.</p>
                    </div>
                </div>

                <div class="media gift-card">
                    <img class="icon" src="{!! url('/') !!}/assets/frontend/images/gift-icon-2.png" alt="Gift Icon">
                    <div class="media-body">
                        <h5 class="mt-0">A Lifetime Memories</h5>
                        <p>We bestow authentic connection with stories with the locals through personalised travelling, We connect travellers with our native guides who know their localities more than anyone else.We bestow authentic connection with stories with the locals through personalised travelling.</p>
                    </div>
                </div>

                <div class="media gift-card">
                    <img class="icon" src="{!! url('/') !!}/assets/frontend/images/gift-icon-3.png" alt="Gift Icon">
                    <div class="media-body">
                        <h5 class="mt-0">More Experience</h5>
                        <p>We bestow authentic connection with stories with the locals through personalised travelling, We connect travellers with our native guides who know their localities more than anyone else.We bestow authentic connection with stories with the locals through personalised travelling.</p>
                    </div>
                </div>

                <div class="media gift-card">
                    <img class="icon" src="{!! url('/') !!}/assets/frontend/images/gift-icon-4.png" alt="Gift Icon">
                    <div class="media-body">
                        <h5 class="mt-0">A Lifetime Memories</h5>
                        <p>We bestow authentic connection with stories with the locals through personalised travelling, We connect travellers with our native guides who know their localities more than anyone else.We bestow authentic connection with stories with the locals through personalised travelling.</p>
                    </div>
                ...
                <div class="media gift-card">
                    <img class="icon" src="{!! url('/') !!}/assets/frontend/images/gift-icon-5.png" alt="Gift Icon">
                    <div class="media-body">
                        <h5 class="mt-0">Get in touch with Locals</h5>
                        <p>We bestow authentic connection with stories with the locals through personalised travelling, We connect travellers with our native guides who know their localities more than anyone else.We bestow authentic connection with stories with the locals through personalised travelling.</p>
                    </div>
                </div>
            </div>
